...
const GameModal = () => {
  ...
  useEffect(() => {
    const listenForKeyDownEvent = document.addEventListener(
      "keydown",
      (e) => e.key.toLowerCase() === "escape" && handleToggleModal(false)
    );
  ...
  return (
    <div
      className="fixed right-0 left-0 flex justify-center items-center h-full w-full top-0 bottom-0 z-[999] bg-gray-400
    "
    >
